...
impl HttpSession {
    ...
    /// Enable replay buffering with a caller-bounded capacity before reading the body.
    /// Returns false if buffering was already enabled; existing bytes are never discarded.
