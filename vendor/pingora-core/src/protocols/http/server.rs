...
impl Session {
    ...
    /// Enable a bounded replay buffer for HTTP/1 or HTTP/2 before pre-reading a body.
    /// Returns false for unsupported sessions or when buffering was already enabled.
